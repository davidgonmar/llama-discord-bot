import pytest
from llama_discord_bot.llama import LlamaBase, Message, ChatUser
...
class TestLlamaBaseGeneratePrompt:
    ...
    def test_system_prompt_bot_first(self):
        ...
        llama = LlamaBase("You are a helpful, respectful and honest assistant.")
        test_messages = [
            Message(ChatUser.AI, "Hello, how are you?"),
            Message(ChatUser.HUMAN, "I'm fine, thanks!"),
            Message(ChatUser.AI, "That's good to hear!"),
        ]
    ...
    def test_system_prompt_user_first(self):
        ...
        llama = LlamaBase("You are a helpful, respectful and honest assistant.")
        test_messages = [
            Message(ChatUser.HUMAN, "Hello, how are you?"),
            Message(ChatUser.AI, "I'm fine, thanks!"),
            Message(ChatUser.HUMAN, "That's good to hear!"),
        ]
...
class TestLlamaBaseMergeConsecutiveMessagesByRole:
    ...
    def test_merge_consecutive_messages_by_role(self):
        ...
        merged_messages = self.llama._merge_consecutive_messages_by_role(test_messages)

        expected_messages = [
            Message(
                ChatUser.HUMAN,
                "Hello, how are you?I'm fine, thanks!That's good to hear!",
            ),
            Message(
                ChatUser.AI, "I'm fine, thanks!That's good to hear!Hello, how are you?"
            ),
        ]
